        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResponseToId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Chats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Chats_Chats_ResponseToId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeenTime = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StaffIdId = table.Column<string>(type: "TEXT", nullable: true),
                    ExaminationDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Symptoms = table.Column<string>(type: "TEXT", nullable: true),
                    Diagnosis = table.Column<string>(type: "TEXT", nullable: true),
                    PrescribedMedication = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalRecords_AspNetUsers_StaffIdId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chats_ResponseToId",
                table: "Chats",
                column: "ResponseToId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalRecords_StaffIdId",
