...
namespace Persistence.Migrations
{
    ...
    [Migration("20250413205806_PatientOptimization")]
    partial class PatientOptimization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Chat", b =>
                {
                    b.HasOne("Domain.Chat", "ResponseTo")
                        .WithMany("Responses")
            ...
            modelBuilder.Entity("Domain.MedicalRecord", b =>
                {
                    b.HasOne("Domain.AppUser", "StaffId")
                        .WithMany()
